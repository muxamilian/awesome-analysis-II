...
Wir benutzen die Zylinderkoordinaten, Funktionaldetermiante ist $r~dr ~ d\varphi ~dz$
   ...
   \[ \text{div } \vec w(x,y,z) =  yz + x^2 + xy\]
    ...
    \textbf{\textsc{Wie hast du das mit Umlaufrichtung herausgefunden? Und warum brauchst du keine Funktionaldeterminante? -- Max}}\\
    \textbf{Die Funktionaldeterminante brauchen wir glaub aus dem Grund nicht, als das wir unser $d\vec O$ ``selbst berechnet'' haben (mit dem Kreuzprodukt der part. Ableitungen) und dort ein Vektor statt eines Skalars wie bei Kugelkoordinaten rauskommt.}\\
    \begin{align*}
...
\textsc{\textbf{Was ist mit der Funktionaldeterminante passiert? -- Max}}
