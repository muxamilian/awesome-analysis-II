...
\begin{enumerate}[(a)]
   ...
   Für $\vec v (r,\varphi, z)$ ergibt sich dann:
   \[ \vec v (r,\varphi, z) = \vecthree{zr\cos\varphi}{r\sin \varphi (r\cos \varphi - z)}{r\cos \varphi (r\sin \varphi - z)} \]
   Da $Z$ ein kompakter Bereich ist kann der Satz von Gauss angewendet werden, womit gilt:
      \begin{align*}
            \iint\limits_{\delta Z} \vec w \cdot d \vec O &= \iiint\limits_{Z} \text{div } \vec w~ r~dr ~d\varphi~ dz \\
            &= \iiint\limits_{Z} (z \cos\varphi + r^2\cos^2\varphi - r^2 \sin^2\varphi - zr \cos \varphi  -1 )~ r~dr ~d\varphi~ dz \\
            &= \iiint\limits_{Z} (z \cos\varphi + r^2\cos^2(2\varphi) - zr \cos \varphi  - r\cos \varphi )~ r~dr ~d\varphi~ dz \\
               &= \iiint\limits_{Z} (z \cos\varphi + r^2\cos^2(2\varphi) - zr \cos \varphi  - r\cos \varphi )~ r~dr ~d\varphi~ dz \\
      \end{align*}
\end{enumerate}
