...
$\mathrm d O$ ist somit:
\begin{align*}
\left|\frac{\partial \vec y}{\partial u} \times \frac{\partial \vec y}{\partial v}\right| ~ \mathrm d u \mathrm d v&= \left|\vecthree{\cos u \cos v}{-\cos u \sin v}{0} \times \vecthree{-\sin u \sin v}{\sin u \cos v}{\sin u}\right| ~ \mathrm d u \mathrm d v\\
\end{align*}
\end{document}
