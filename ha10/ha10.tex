...
\begin{enumerate}[a)]
   \item 
            \begin{align*}
               \int^{1}_0\int^{2}_{1}xye^{xy^2} dxdy &= \int^{1}_0 \left. \frac{1}{y^3}e^{xy^2}(-1 + y^2x)\right|_{1}^{2} dy \\ 
               &=   \int^{1}_0 (\frac{1}{y^3}e^{2y^2}(2y^2 - 1)) - (\frac{1}{y^3}e^{y^2}(y^2 - 1)) dy = \left. \frac{e^{y^2}(e^{y^2} -1)}{2y^2} \right|_0^1\\
               &= \frac{e^2 -e}{2}
            \end{align*}
   \item 
            \begin{align*}
               \int^{2}_{1}\int^1_0\int^y_0(x+1) dzdydx &=
            \end{align*}
   \item 
            \begin{align*}
               \int^{1}_{0}\int^{1+y}_{\sqrt{y}}(xy^3) dxdy &=
            \end{align*}
\end{enumerate}
\section*{Aufgabe 2}
\begin{align*}
