...
&\le \lim_{\Delta \vec x \to \vec 0} \left|\frac{x^2y^2}{(2xy)^{\frac{3}{2}}}\right| \\
&= \lim_{\Delta \vec x \to \vec 0} \left|\frac{(xy)^2}{(2xy)^{\frac{3}{2}}}\right| \\
&\le \lim_{\Delta \vec x \to \vec 0} \left|\frac{(2xy)^2}{(2xy)^{\frac{3}{2}}}\right| \\
&= \lim_{\Delta \vec x \to \vec 0} \left|\sqrt{2xy}\right| \\
&= 0
\end{align*}
