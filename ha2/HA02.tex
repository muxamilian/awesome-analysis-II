...
\end{minipage}
\item 
Da $f$ eine Komposition von stetigen Funktionen ist, sowie das Intervall $D$ kompakt ist, muss $f$ Minima und Maxima in $D$ annehmen. Da die Niveaulinien konzentrische Ellipsen mit Mittelpunkt in $(0,0)$ sind, nimmt die Funktion dort ihr Minimum an und an den Intervallgrenzen ihre Maxima. %Anhand der Bilder ist ein leichtes zu sehen, wo Minima und Maxima auftreten. \textbf{Minima: } $f(0,0) = 4$, \textbf{Maxima: } %$f(0,1) = \frac{52}{9}$$f(-2,0) = 5 = f(2,0)$
